...
{
    void newTopic(final  String     topicName);
    void startTest(final String     testName);
    void progress(final  String     progressMessage);
    void endTest(final   TestResult testResult);
}
