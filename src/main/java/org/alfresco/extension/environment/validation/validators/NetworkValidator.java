    ...
    extends AbstractValidator
{
    ...
    private final PortValidationRule[] TCP_PORTS = {
                                                       new PortValidationRule(8005,  "Tomcat",     TestResult.FAIL, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Tomcat instance) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(8080,  "HTTP",       TestResult.FAIL, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Tomcat instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(8085,  "HTTP",       TestResult.FAIL, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Tomcat instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(8009,  "HTTP",       TestResult.FAIL, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Tomcat instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(8105,  "HTTP",       TestResult.WARN, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Tomcat instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(8109,  "HTTP",       TestResult.WARN, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Tomcat instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(8180,  "HTTP",       TestResult.WARN, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Tomcat instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(8443,  "HTTP",       TestResult.FAIL, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Tomcat instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(44100,  "HTTP",       TestResult.FAIL, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Tomcat instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(44101,  "HTTP",       TestResult.FAIL, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Tomcat instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),                                                      
                                                       new PortValidationRule(50500, "RMI",        TestResult.FAIL, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Alfresco instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(50501, "RMI",        TestResult.FAIL, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Alfresco instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(50502, "RMI",        TestResult.FAIL, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Alfresco instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(50503, "RMI",        TestResult.FAIL, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Alfresco instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(50504, "RMI",        TestResult.FAIL, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Alfresco instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(50505, "RMI",        TestResult.FAIL, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Alfresco instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(50506, "RMI",        TestResult.FAIL, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Alfresco instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(50507, "RMI",        TestResult.FAIL, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Alfresco instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(50510, "RMI",        TestResult.WARN, "Alfresco will not start", "Check for running processes that are using this port (eg. existing Alfresco instances) Please refer to https://wiki.alfresco.com/wiki/Port_numbers"),
                                                       new PortValidationRule(21,    "FTP",        TestResult.WARN, "FTP protocol will be unavailable", "Check for running processes that are using this port (eg. existing FTP servers), " 
                                                                                                                                                        ...
                                                                                                                                                        + "alternate port 2121 will be tested next"),
                                                       //alternate TCP
