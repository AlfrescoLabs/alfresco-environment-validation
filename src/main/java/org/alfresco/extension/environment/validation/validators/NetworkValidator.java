    ...
    extends AbstractValidator
{
    ...
    private final PortValidationRule[] TCP_PORTS = {
                                                       ...
                                                       new PortValidationRule(21,    "FTP",        TestResult.WARN, "FTP protocol will be unavailable", "Check for running processes that are using this port (eg. existing FTP servers), on non-Windows OSes consider reconfiguring Alfresco to use a non-privileged port then use a port forwarding tool (such as iptables) to forward this port"),
